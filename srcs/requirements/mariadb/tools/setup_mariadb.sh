...
mariadb -u root -e "CREATE DATABASE IF NOT EXISTS $GRAFANA_DATABASE;"
...
mariadb -u root -e "GRANT ALL PRIVILEGES ON $GRAFANA_DATABASE.* TO '$MYSQL_USER'@'%'; FLUSH PRIVILEGES;"
